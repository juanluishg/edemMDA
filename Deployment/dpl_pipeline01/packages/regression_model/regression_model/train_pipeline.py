...
FEATURES = ['MSSubClass', 'MSZoning', 'Neighborhood', 'OverallQual',
            ...
            # sólo para el cálculo de variables temporales:
            'YrSold']
...
def run_training() -> None:
    ...
    print('Aquí el modelo haría su entrenamiento ----------------------------------------------------------------------------------------- Si lees este mensaje ya tienes todo listo para conectar tu pipeline.')
